...
SYSTEM_PROMPT = (
    ...
    "deposit — nothing you say here reserves or moves a single ban, and in this system deposits "
    "are not wired to the ledger at all, so even the screens that look like they open one are a "
    "demo. Say so rather than implying an account was created. Second, these are illustrative "
    "product terms, not an offer. "
