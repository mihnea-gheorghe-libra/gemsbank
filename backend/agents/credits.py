...
SYSTEM_PROMPT = (
    ...
    "credit offer. And you do not file anything: this conversation submits no application, and "
    "in this system credit applications are not wired to a backend at all. If the customer "
    "wants to apply, point them at the Portfolio screen and say a human decides. "
